...
class TranslationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Health = channel.unary_unary(
                '/translation.TranslationService/Health',
                request_serializer=translation__pb2.HealthRequest.SerializeToString,
                response_deserializer=translation__pb2.HealthResponse.FromString,
...
def add_TranslationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Health': grpc.unary_unary_rpc_method_handler(
                    servicer.Health,
                    request_deserializer=translation__pb2.HealthRequest.FromString,
                    response_serializer=translation__pb2.HealthResponse.SerializeToString,
            ),
...
class TranslationService(object):
    ...
    def Health(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/translation.TranslationService/Health',
            translation__pb2.HealthRequest.SerializeToString,
            translation__pb2.HealthResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
