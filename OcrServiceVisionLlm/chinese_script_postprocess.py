    ...
    def postprocess_translations(
        ...
        for text in texts:
            ...
            try:
                ...
                # WHY: Script conversion is a display-side cleanup and must not break OCR/translation delivery.
        ...
        if OpenCC is None:
            if not self._import_warning_logged:
                self._logger.warning(
                    ...
                    "Install opencc-python-reimplemented in OcrServiceVisionLlm environment."
                )
