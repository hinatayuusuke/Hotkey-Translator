...
public sealed class AppSettings
{
    ...
    public int VisionLlmContextSize { get; set; } = 4096;
    public int VisionLlmGpuLayers { get; set; } = 999;
    public int VisionLlmThreads { get; set; } = 4;
    public int VisionLlmParallel { get; set; } = 1;
    public int VisionLlmBatchSize { get; set; } = 512;
    public int VisionLlmMaxTokens { get; set; } = 512;
    public string VisionLlmSelectedModelFileName { get; set; } = "Qwen3.5-9B-Q4_K_M.gguf";
    public string VisionLlmSelectedMmprojFileName { get; set; } = "mmproj-F16.gguf";
    public int VisionLlmMaxImageSide { get; set; } = 1024;
