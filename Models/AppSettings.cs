...
public sealed class AppSettings
{
    ...
    public int PhashThreshold { get; set; } = 0;
    ...
    public int HorizontalMergeStrength { get; set; } = 35;
    public int VerticalMergeStrength { get; set; } = 35;
    public double MergeOverlapRatioThreshold { get; set; } = 0.12956;
    public double MergeVerticalWeight { get; set; } = 0.8804;
    public double MergeThresholdRatio { get; set; } = 0.96132;
    ...
    public double RowMergeMaxGapRatio { get; set; } = 1.6044;
    public double RowMergeHardBreakRatio { get; set; } = 2.04528;
    ...
    public double VerticalGapRatio { get; set; } = 1.36352;
    public bool EnableVerticalColumnMerge { get; set; } = true;
    public int VerticalColumnMergeNeighborCount { get; set; } = 8;
    public double VerticalColumnMergeOverlapRatioThreshold { get; set; } = 0.223208;
    public double VerticalColumnMergeWeight { get; set; } = 0.5;
    public double VerticalColumnMergeThresholdRatio { get; set; } = 0.981761;
    public double VerticalColumnMergeHardBreakRatio { get; set; } = 1.8044;
    ...
    public string HotkeyRunOnceKey { get; set; } = HotkeyDefaults.RunOnceKey;
    public string HotkeyRunOnceModifiers { get; set; } = HotkeyDefaults.RunOnceModifiers;
    public string HotkeyRunNextRoiKey { get; set; } = HotkeyDefaults.RunNextRoiKey;
    public string HotkeyRunNextRoiModifiers { get; set; } = HotkeyDefaults.RunNextRoiModifiers;
    public string HotkeyRunNextNextRoiKey { get; set; } = HotkeyDefaults.RunNextNextRoiKey;
    public string HotkeyRunNextNextRoiModifiers { get; set; } = HotkeyDefaults.RunNextNextRoiModifiers;
    public string HotkeyToggleOverlayKey { get; set; } = HotkeyDefaults.ToggleOverlayKey;
    public string HotkeyToggleOverlayModifiers { get; set; } = HotkeyDefaults.ToggleOverlayModifiers;
    public string HotkeyForceRunKey { get; set; } = HotkeyDefaults.ForceRunKey;
    public string HotkeyForceRunModifiers { get; set; } = HotkeyDefaults.ForceRunModifiers;
    public string HotkeyForceRunNextRoiKey { get; set; } = HotkeyDefaults.ForceRunNextRoiKey;
    public string HotkeyForceRunNextRoiModifiers { get; set; } = HotkeyDefaults.ForceRunNextRoiModifiers;
    public string HotkeyForceRunNextNextRoiKey { get; set; } = HotkeyDefaults.ForceRunNextNextRoiKey;
    public string HotkeyForceRunNextNextRoiModifiers { get; set; } = HotkeyDefaults.ForceRunNextNextRoiModifiers;
    public string HotkeyForceGeminiStrictKey { get; set; } = HotkeyDefaults.ForceGeminiStrictKey;
    public string HotkeyForceGeminiStrictModifiers { get; set; } = HotkeyDefaults.ForceGeminiStrictModifiers;
    public string HotkeyOcrOnlyKey { get; set; } = HotkeyDefaults.OcrOnlyKey;
    public string HotkeyOcrOnlyModifiers { get; set; } = HotkeyDefaults.OcrOnlyModifiers;
    public string HotkeyToggleSceneAutoTranslateKey { get; set; } = HotkeyDefaults.ToggleSceneAutoTranslateKey;
    ...
    public string HotkeyPreviousRoiPresetModifiers { get; set; } = HotkeyDefaults.PreviousRoiPresetModifiers;
    public string HotkeyLockCaptureWindowKey { get; set; } = HotkeyDefaults.LockCaptureWindowKey;
    public string HotkeyLockCaptureWindowModifiers { get; set; } = HotkeyDefaults.LockCaptureWindowModifiers;
    public string HotkeyUnlockCaptureWindowKey { get; set; } = HotkeyDefaults.UnlockCaptureWindowKey;
    public string HotkeyUnlockCaptureWindowModifiers { get; set; } = HotkeyDefaults.UnlockCaptureWindowModifiers;
    public string HotkeyToggleMirrorFullscreenKey { get; set; } = HotkeyDefaults.ToggleMirrorFullscreenKey;
    public string HotkeyToggleMirrorFullscreenModifiers { get; set; } = HotkeyDefaults.ToggleMirrorFullscreenModifiers;
